...
def generate_folders():
    ...
    for item in data:
        ...
        # try: os.mkdir(f'website/{domain}')
        # except: pass
        # try: os.mkdir(f'website/{domain}/{kingdom}')
        # except: pass
        # try: os.mkdir(f'website/{domain}/{kingdom}/{phylum}')
        # except: pass
        # try: os.mkdir(f'website/{domain}/{kingdom}/{phylum}/{_class}')
        # except: pass
        # try: os.mkdir(f'website/{domain}/{kingdom}/{phylum}/{_class}/{order}')
        # except: pass
        # try: os.mkdir(f'website/{domain}/{kingdom}/{phylum}/{_class}/{order}/{family}')
        # except: pass
        # try: os.mkdir(f'website/{domain}/{kingdom}/{phylum}/{_class}/{order}/{family}/{genus}')
        # except: pass
        ...
        # except: pass
        # try: os.mkdir(f'website/{kingdom}')
        # except: pass
        # try: os.mkdir(f'website/{kingdom}/{phylum}')
        # except: pass
        # try: os.mkdir(f'website/{kingdom}/{phylum}/{_class}')
        # except: pass
        # try: os.mkdir(f'website/{kingdom}/{phylum}/{_class}/{order}')
        # except: pass
        # try: os.mkdir(f'website/{kingdom}/{phylum}/{_class}/{order}/{family}')
        # except: pass
        # try: os.mkdir(f'website/{kingdom}/{phylum}/{_class}/{order}/{family}/{genus}')
        # except: pass
        try: os.mkdir(f'website/assets')
        except: pass
        try: os.mkdir(f'website/assets/images')
