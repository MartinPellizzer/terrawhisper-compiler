...
def a_herbs_popular():
    popular_teas = get_popular_teas()
    for herb_i, herb in enumerate(popular_teas):
        print(f'{herb_i} - {herb}')
        herb_name_scientific = herb['herb_name_scientific']
...
def categories_herbs():
    categories = []
    for herb_i, herb in enumerate(plants_wcvp[:307]):
        print(f'{herb_i} - {herb}')
        herb_name_scientific = herb['scientfiicname']
        herb_slug = herb_name_scientific.strip().lower().replace(' ', '-').replace('.', '')
        url = f'herbs/{herb_slug}'
...
def page_herbs():
    ...
    for page in pages:
        ...
        if page_i == 1:
            ...
            html_filepath = f'{website_folderpath}/herbs/page-{page_i}.html'
            breadcrumbs_html_filepath = f'herbs/page-{page_i}.html'
            breadcrumbs_html = breadcrumbs_gen(breadcrumbs_html_filepath)
            html = f'''
                <!DOCTYPE html>
                <html lang="en">
        ...
        <section>
            <div class="container-xl mob-flex gap-64 mt-64">
                <div class="flex-2">
                    ...
                    <p>Need something? The best way to contact Terrawhisper is to send and email at <u>martin@terrawhisper.com</u></p>
