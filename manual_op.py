...
# for entity in os.listdir(f'database/articles/'):
#     try: os.remove(f'database/articles/{entity}/medicine/side-effects.md')
#     except: pass

#     try: os.rename(
#         f'database/articles/{entity}/medicine/effects.md', 
#         f'database/articles/{entity}/medicine/side-effects.md')
#     except: pass