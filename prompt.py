...
if len(sys.argv) != 2:
    print("ERR: missing argument ENTITY")
    quit()
...
print(f'''
11. Here's a list of morphological characteristics of leaves of {entity}:
...
''')
print(f'''
12. Using the data from the previous table, write a section for an article of less than 300 words. 
...
i = 1
print(f'''
{i}. Here's a list of morphological characteristics of flowers of {entity}:
...
print(f'''
{i}. Here's a list of morphological characteristics of fruits of {entity}:
...
print(f'''
{i}. Here's a list of morphological characteristics of seeds of {entity}:
