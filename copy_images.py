        ...
        for image_path in os.listdir(f'{start_folder}/{entity_folder}'):
            if image_path.endswith('.jpg'):
                ...
                if not os.path.exists(out_path):
                    shutil.copy2(f'{start_folder}/{entity_folder}/{image_path}', out_path)
                    print(out_path)
    except: pass
    ...
    try:
        for image_path in os.listdir(f'{start_folder}/{entity_folder}/medicine'):
            if image_path.endswith('.jpg'):
                ...
                out_path = f'{website_img_path}/{image_path}'
                if not os.path.exists(out_path):
                    shutil.copy2(f'{start_folder}/{entity_folder}/medicine/{image_path}', out_path)
                    print(out_path)
    except: pass
    ...
    try:
        for image_path in os.listdir(f'{start_folder}/{entity_folder}/medicine/preparations'):
            if image_path.endswith('.jpg'):
                ...
                out_path = f'{website_img_path}/{image_path}'
                if not os.path.exists(out_path):
                    shutil.copy2(f'{start_folder}/{entity_folder}/medicine/preparations/{image_path}', out_path)
                    print(out_path)
    except: pass
    ...
    try:
        for image_path in os.listdir(f'{start_folder}/{entity_folder}/medicine/side-effects'):
            if image_path.endswith('.jpg'):
                ...
                out_path = f'{website_img_path}/{image_path}'
                if not os.path.exists(out_path):
                    shutil.copy2(f'{start_folder}/{entity_folder}/medicine/side-effects/{image_path}', out_path)
                    print(out_path)
    except: pass